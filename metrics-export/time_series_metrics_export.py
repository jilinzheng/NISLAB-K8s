...
SCENARIOS = [
    ...
    "random-yoyo-10x",
    "random-yoyo-20x",
    "random-state-aware-5x",
    "random-state-aware-10x",
    "random-state-aware-20x",
    "onoff-yoyo-5x",
    "onoff-yoyo-10x",
    "onoff-yoyo-20x",
    ...
    "onoff-state-aware-5x",
    "onoff-state-aware-10x",
    "onoff-state-aware-20x",
    ...
    "bursty-yoyo-10x",
    "bursty-yoyo-20x",
    "bursty-state-aware-5x",
    "bursty-state-aware-10x",
    "bursty-state-aware-20x",
...
for i in range(len(SCENARIOS)):
    for j in range(len(TIMEFRAMES)):
        for k in range(len(QUERIES)):
            ...
            filename = f"./250329_{SCENARIOS[i]}_{QUERIES[k][1].replace(' ','_').lower()}_{TIMEFRAMES[j]}.csv"
            df = pd.DataFrame(
